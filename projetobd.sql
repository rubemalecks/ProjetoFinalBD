...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17-Dez-2022 às 03:39
...
INSERT INTO `dependentes` (`RG`, `nome`, `sexo`, `MatricProf`, `DataNasc`) VALUES
...
('Pedro', 'Pereira da Silva', 121003, '1982-03-25', '4000.00', NULL, 121, 'M'),
('José\r\nMaria', 'Campos', 121031, '1978-04-10', '7000.00', 121003, 121, 'M'),
('Bento', 'Diniz Costa', 122045, '1980-11-27', '4000.00', NULL, 122, 'M'),
('Ana Clara', 'Araújo Santos', 122047, '1994-12-30', '7200.00', 122045, 122, 'F'),
('Maria Luiza', 'Machado', 125331, '1974-08-16', '6800.00', 125332, 125, 'F'),
('Joana Maria', 'Campos Pereira', 125332, '1990-06-12', '4500.00', NULL, 125, 'F'),
('João Carlos', 'Matos Cavalcanti', 125335, '1976-07-22', '3700.00', 125332, 125, 'M');
...
INSERT INTO `projetos` (`nome`, `codigo`, `depto`, `duraçao_ano`) VALUES
('Aplicações de Big Data', 42, 121, 1),
...
--
ALTER TABLE `projetos`
  ADD CONSTRAINT `projetos_ibfk_1` FOREIGN KEY (`depto`) REFERENCES `departamento` (`codigo`);
COMMIT;
